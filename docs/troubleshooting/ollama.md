...
When using Ollama as a provider with oh-my-patoniagent agents, you may encounter:
...
- **oh-my-patoniagent**: Passes through the SDK's behavior (can't fix at this layer)
...
**Tracking**: https://github.com/gataungapainn/oh-my-patoniagent/issues/1124 (closed - documented workaround)
...
- **oh-my-patoniagent**: https://github.com/gataungapainn/oh-my-patoniagent/issues/1124 (closed - workaround documented)
