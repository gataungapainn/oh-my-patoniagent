---
description: Publish oh-my-patoniagent to npm via GitHub Actions workflow
argument-hint: <patch|minor|major>
---

<command-instruction>
You are the release manager for oh-my-patoniagent. Execute the FULL publish workflow from start to finish.
...
for PLATFORM in $PLATFORMS; do
  npm view "oh-my-patoniagent-${PLATFORM}" version
done
```
...
| Package | Description |
|---------|-------------|
| `oh-my-patoniagent-darwin-arm64` | macOS Apple Silicon |
| `oh-my-patoniagent-darwin-x64` | macOS Intel |
| `oh-my-patoniagent-linux-x64` | Linux x64 (glibc) |
| `oh-my-patoniagent-linux-arm64` | Linux ARM64 (glibc) |
| `oh-my-patoniagent-linux-x64-musl` | Linux x64 (musl/Alpine) |
| `oh-my-patoniagent-linux-arm64-musl` | Linux ARM64 (musl/Alpine) |
| `oh-my-patoniagent-windows-x64` | Windows x64 |
...
- New version number
- GitHub release URL: https://github.com/gataungapainn/oh-my-patoniagent/releases/tag/v{version}
- npm package URL: https://www.npmjs.com/package/oh-my-patoniagent
...
<current-context>
<published-version>
!`npm view oh-my-patoniagent version 2>/dev/null || echo "not published"`
</published-version>
<local-version>
...
<recent-commits>
!`npm view oh-my-patoniagent version 2>/dev/null | xargs -I{} git log "v{}"..HEAD --oneline 2>/dev/null | head -15 || echo "no commits"`
</recent-commits>
</current-context>
