...
import type { OhMyPatoniAgentConfig } from "../../config/schema"

export function getTaskDir(config: Partial<OhMyPatoniAgentConfig> = {}): string {
...
export function resolveTaskListId(config: Partial<OhMyPatoniAgentConfig> = {}): string {
...
export function listTaskFiles(config: Partial<OhMyPatoniAgentConfig> = {}): string[] {
