...
37 files. Powers the `oh-my-patoniagent run <message>` command. Connects to OpenCode server, creates/resumes sessions, streams events, and polls for completion.
