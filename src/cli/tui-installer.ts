...
export async function runTuiInstaller(args: InstallArgs, version: string): Promise<number> {
  ...
  p.log.info("Anonymous telemetry is enabled by default. Disable it with OMPA_SEND_ANONYMOUS_TELEMETRY=0 or OMPA_DISABLE_POSTHOG=1.")
  ...
  p.log.message(
    `  ${color.dim("gh api --silent --method PUT /user/starred/gataungapainn/oh-my-patoniagent >/dev/null 2>&1 || true")}`,
  )
