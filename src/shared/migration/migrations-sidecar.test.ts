...
describe("migrations sidecar", () => {
  ...
  describe("getSidecarPath", () => {
    test("appends .migrations.json to the config path", () => {
      expect(getSidecarPath("/home/user/.config/opencode/oh-my-patoniagent.json")).toBe(
        "/home/user/.config/opencode/oh-my-patoniagent.json.migrations.json",
      )
    })

    test("works for jsonc configs too", () => {
      expect(getSidecarPath("/home/user/oh-my-patoniagent.jsonc")).toBe(
        "/home/user/oh-my-patoniagent.jsonc.migrations.json",
      )
    })
  })
  ...
  describe("writeAppliedMigrations", () => {
    ...
    test("creates parent directories if they do not exist yet", () => {
      ...
      const configPath = join(nested, "oh-my-patoniagent.json")
    ...
    test("round-trips via readAppliedMigrations", () => {
      const configPath = join(workdir, "oh-my-patoniagent.jsonc")
