...
Cross-cutting utilities used throughout the plugin. Barrel-exported from `index.ts`. Logger writes to `/tmp/oh-my-patoniagent.log`.
...
|---------|-------------|---------|
| `logger.ts` | 62 | `/tmp/oh-my-patoniagent.log` |
